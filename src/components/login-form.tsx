        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
              ...
              {(urlError === 'not_authorized' || urlError === 'google_failed') && (
                <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start space-x-3">
                  <svg className="h-5 w-5 text-red-400 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl bg-white text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              >
                {isGoogleLoading ? (
